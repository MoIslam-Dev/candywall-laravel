...
<div class="alert alert-warning">
    <ul class="mb-0">
        <li>Do not add any website where user needs to put his personal data. Be aware of it.</li>
        <li>Do not add any bad site which violates Google Play Policy.</li>
        <li>Do not add any website to download contents by the app.</li>
    </ul>
</div>
...
@endif
<div class="row">
    <form class="card" method="post" action="{{route('networks_ppv_add')}}">
        @csrf
        ...
        <div class="card-body row">
            ...
            <div class="mb-3 col-md-4 col-sm-12">
                <label class="form-label">Can visit per day <span class="text-blue">(set <span class="text-red">0</span> for once forever)</span>:</label>
                <div class="input-group">
                    <input type="text" class="form-control" name="visit_per_day" placeholder="0" value="{{old('visit_per_day')}}">
            ...
            <table class="table table-vcenter card-table table-striped">
                <thead>
                    <tr>
                        ...
                        <th class="small-col text-center">Per day</th>
                        <th class="small-col text-center">{{env('CURRENCY_NAME')}}s</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-muted text-center">{{$d->per_day}}</td>
