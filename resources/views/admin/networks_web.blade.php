...
<div class="card">
    <div class="card-header pt-2 pb-0">
        <span class="h4 nav-link active font-weight-bold">عروض WEB</span>
    </div>
    <div class="card-body row mt-2 pb-1">
        ...
        <div class="col-lg-4 col-md-6 col-12">
            <div class="card bg-gray-lt">
                <div class="card-header py-2">
                    <img src="{{$d['image']}}" class="rounded text-truncate text-small py-1 mr-2" alt="Own Offerwall" height="36px">
                    <h3 class="card-title text-dark text-truncate mr-1">{{$d['name']}}</h3>
                    <div class="card-actions mr-1">
                        <a href="{{route('networks_web_edit', ['id' => $d['of_id']])}}">
                            تعديل الشبكة
                ...
                <div class="card-body py-3">
                    <dl class="row">
                        <dt class="col-5 text-truncate text-dark h4 my-0">حالة العرض:</dt>
        ...
        <div class="col-lg-4 col-md-6 col-12 pb-4">
            <a href="{{route('networks_web_new')}}" class="card bg-gray-lt h-100 mb-0 pt-2 justify-content-center align-self-center text-center">
                <span>
                ...
                <p class="h3 bg-dark">اضافة شبكة جديدة</p>
            </a>
        </div>
    </div>
</div>
