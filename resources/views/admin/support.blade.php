...
<div class="row h-100">
   ...
   <div class="col-lg-8 col-md-7 col-sm-12">
    <div class="card">
        <div id="userinfo" class="card-header">مربع الدردشة</div>
        <div id="msg-parent" class="card-body cb align-items-end">
            <div id='msg' class="w-100">
                <div class="cb-child d-flex align-items-center justify-content-center">
                    انقر على محادثة من اليسار لعرض الرسائل هنا.
                </div>
            </div>
        </div>
        <div class="card-footer d-flex">
            <input type="hidden" id="userid" />
            <input id="msg-input" type="text" class="form-control mr-3" placeholder="اكتب هنا...">
            <a id='sbtn' class="ml-auto btn btn-dark cb-btn text-white" onclick="sendMessage();">إرسال</a>
        </div>
    </div>
</div>
</div>
    ...
    <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div>أنت على وشك إزالة هذه المحادثة بالكامل.</div>
            </div>
