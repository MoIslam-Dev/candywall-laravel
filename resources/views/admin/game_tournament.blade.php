    ...
    <div class="col-lg-4 col-md-5 col-sm-12">
        <div class="row">
            <div class="col-md-6 col-sm-12 mb-3">
                <a href="#" class="btn btn-edit btn-block btn-primary" data-id="-1" data-qs="" data-op="" data-ans="" data-time="" data-sc="" data-toggle="modal" data-target="#qs-edit" data-backdrop="static" data-keyboard="false">Add a question</a>
            </div>
            <div class="col-md-6 col-sm-12 mb-3">
                <a href="#" class="btn btn-del btn-block btn-danger" data-id="-1" data-toggle="modal" data-target="#qs-del" data-backdrop="static" data-keyboard="false">Delete all questions</a>
            </div>
        </div>
        <form class="card px-0" method="post" action="{{route('game_tour_sett')}}">
            ...
            <div class="card-body">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="name" placeholder="Quiz Tournament" value="{{old('name', $data['s']['name'])}}">
                </div>
                <div class="mb-3">
                    <label class="form-label">Tournament will begin on:</label>
                    <input type="text" class="form-control" name="begin_time" id="begin-date" placeholder="h:m dd/mm/yyyy" value="{{old('begin_time', $data['s']['begin_time'])}}">
                </div>
                <div class="mb-3">
                    <label class="form-label">Result will be published after:</label>
                    <div class="input-group">
                        <input type="text" class="form-control" name="publish_time" placeholder="30" value="{{old('publish_time', $data['s']['publish_time'])}}">
                        <span class="input-group-text">minutes</span>
                    </div>
                </div>
                <div class="mb-3">
                    <label class="form-label">Result will show until:</label>
                    <input type="text" class="form-control" name="result_time" id="result-until" placeholder="h:m dd/mm/yyyy" value="{{old('result_time', $data['s']['result_time'])}}">
                </div>
                <div class="row">
                    <div class="col-md-6 col-sm-12">
                        <label class="form-label">Entry fee:</label>
                        <div class="input-group">
                            <input type="text" class="form-control" name="fee" placeholder="30" value="{{old('fee', $data['s']['fee'])}}">
                    ...
                    <div class="col-md-6 col-sm-12">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" name="reward" placeholder="5000" value="{{old('reward', $data['s']['reward'])}}">
                            <span class="input-group-text">{{strtolower(env('CURRENCY_NAME'))}}s</span>
                        </div>
                    </div>
                </div>
        ...
        <form class="card card-body" method="get" action="{{route('game_tour_winner_form')}}">
            <div class="d-flex">
                <div class="w-100">
                    ...
                    <input type="text" class="form-control" name="total_winners" value="{{env('TOUR_WINNER_COUNT')}}">
                </div>
                <div>
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-12">
                <div class="card card-body mb-2">
                    ...
                    <a href="#" class="item-btn1 btn-edit" data-id="{{$d->id}}" data-qs="{{$d->question}}" data-op="{!!str_replace(';;','&#10;', $d->options)!!}" data-ans="{{$d->answer}}" data-time="{{$d->time}}" data-sc="{{$d->score}}" data-toggle="modal" data-target="#qs-edit" data-backdrop="static" data-keyboard="false">
                    ...
                    <a href="#" class="item-btn2 btn-del" data-id="{{$d->id}}" data-toggle="modal" data-target="#qs-del" data-backdrop="static" data-keyboard="false">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-md" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                            <path stroke="none" d="M0 0h24v24H0z" />
                    ...
                    <div class="hr-text hr-text-right my-3 font-weight-bold text-blue">{{$d->time}} seconds &bull;&bull;&bull;&bull; {{$d->score}} {{strtolower(env('CURRENCY_NAME'))}}s</div>
...
<form method="post" action="{{route('game_tour_qs_del')}}" class="modal modal-blur fade" id="qs-del" tabindex="-1" role="dialog" aria-hidden="true">
    @csrf
...
<form method="post" action="{{route('game_tour_qs_add')}}" class="modal modal-blur fade" id="qs-edit" tabindex="-1" role="dialog" aria-hidden="true">
    @csrf
        ...
        <div class="modal-content card">
            ...
            <div class="card-body">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" placeholder="What is the capital of United States?" name="question" id="qs_qs">
                </div>
                <div class="mb-3">
                    <label class="form-label">Options:</label>
                    <textarea class="form-control" name="options" rows="4" placeholder="California&#10;New York&#10;Washington, D.C.&#10;Arizona" id="qs_op"></textarea>
                </div>
                <div class="mb-3">
...
@endsection
@section('javascript')
<script type="text/javascript" src="/public/js/jquery.datetimepicker.full.min.js"></script>
<script>
