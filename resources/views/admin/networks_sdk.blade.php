...
<div class="card">
    <div class="card-header pt-2 pb-0">
        <span class="h4 nav-link active font-weight-bold">عروض SDK</span>
    </div>
        ...
        <div class="col-lg-4 col-md-6 col-12">
            <div class="card bg-gray-lt">
                <div class="card-header py-2">
                    ...
                    <h3 class="card-title text-dark mr-2">{{$d['name']}}</h3>
                ...
                <div class="card-body py-3">
                    <dl class="row">
                        <dt class="col-5 text-truncate text-dark h4 my-0">حالة الشبكة:</dt>
                        <dd class="col-7 text-truncate text-muted h5">
                            @if($d['status'] == '1')
                            <span class="text-green">مفغلة</span>
                            @else
...
<script>
    $(document).on("click", ".copy-event", function () {
        ...
        if (copyText == 'None') {
            field.html('<span class="text-red">لا شيء لنسخ!</span>')
        } else {
            var temp = $("<input>");
            $("body").append(temp);
            ...
            field.html('<span class="text-blue">تم نسخ النص!</span>')
        }
    });
