...
<div class="row">
    <div class="col-lg-4 col-md-5 col-sm-12">
        <form class="card px-0" method="post" action="{{route('game_quiz_category_add')}}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="card-body">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="quiz_category_name" placeholder="General" value="{{old('quiz_category_name')}}">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" name="quiz_category_description" rows="3" placeholder="Enter a description here...">{!!old('quiz_category_description')!!}</textarea>
                </div>
                <div class="row">
                    <div class="col-sm-6 mb-3">
                        <label class="form-label">Time limit per quiz:</label>
                        <div class="input-group">
                            <input type="text" class="form-control" name="quiz_category_time" placeholder="30" value="{{old('quiz_category_time')}}">
                            <span class="input-group-text">sec</span>
                        </div>
                    </div>
                    <div class="col-sm-6 mb-3">
                        <label class="form-label">Reward per quiz:</label>
                        <div class="input-group">
                            <input type="text" class="form-control" name="quiz_category_reward" placeholder="10" value="{{old('quiz_category_reward')}}">
                            <span class="input-group-text">sec</span>
                        </div>
                    </div>
                </div>
        ...
        <div class="card card-body">
            <a href="#" class="btn btn-block btn-primary" data-toggle="modal" data-target="#cat-update" data-backdrop="static" data-keyboard="false">Update Quiz Settings</a>
        </div>
    </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="card">
                    ...
                    <div class="btns">
                        ...
                        <a href="#" class="btn-edit" data-id="{{$c->id}}" data-title="{{$c->title}}" data-desc="{{$c->description}}" data-reward="{{$c->reward}}" data-time="{{$c->quiz_time}}" data-toggle="modal" data-target="#cat-edit" data-backdrop="static" data-keyboard="false">
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-md" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" />
...
<form method="post" action="{{route('game_quiz_category_del')}}" class="modal modal-blur fade" id="cat-del" tabindex="-1" role="dialog" aria-hidden="true">
    @csrf
...
<form method="post" action="{{route('game_quiz_category_edit')}}" class="modal modal-blur fade" id="cat-edit" tabindex="-1" role="dialog" aria-hidden="true" enctype="multipart/form-data">
    @csrf
        ...
        <div class="modal-content card">
            <div class="card-body">
                ...
                <div class="mb-3">
                    <label class="form-label">Card image:</label>
                    <div class="form-file">
                        <input type="file" name="update_card_image" class="form-file-input img-input" id="imagefile">
                        <label class="form-file-label" for="customFile">
                            <span class="form-file-text img-choose">Choose image...</span>
                            <span class="form-file-button">Browse</span>
                        </label>
                ...
                <div class="mb-3">
                    <label class="form-label">Description:</label>
                    <textarea class="form-control" name="update_category_description" rows="3" id="cat_desc"></textarea>
                </div>
                <div class="row">
                    <div class="col-sm-6 mb-3">
                        <label class="form-label">Time limit per quiz:</label>
                    ...
                    <div class="col-sm-6 mb-3">
                        <label class="form-label">Reward per quiz:</label>
                        <div class="input-group">
                            <input type="text" class="form-control" name="update_category_reward" id="cat_reward">
                            <span class="input-group-text">sec</span>
                        </div>
                    </div>
                </div>
...
<form method="post" action="{{route('game_quiz_settings_update')}}" class="modal modal-blur fade" id="cat-update" tabindex="-1" role="dialog" aria-hidden="true">
    @csrf
    <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
        <div class="modal-content card">
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control" name="incorrect" value="{{env('QUIZ_WRONG_LIMIT')}}">
