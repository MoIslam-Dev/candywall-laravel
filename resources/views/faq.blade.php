        ...
        <div class="content">
            <div class="container-xl">
                <div class="card card-body">
                    <div class="text-center h3 mb-4">أسئلة مكررة</div>
                    @foreach($data as $d)
                    ...
                    <div class="row text-center align-items-center flex-row-reverse">
                        <div class="col-lg-auto ml-lg-auto">
                            <ul class="list-inline list-inline-dots mb-0">
                                <li class="list-inline-item"><a href="{{route('home')}}" class="link-secondary">الرئيسية</a></li>
                                <li class="list-inline-item"><a href="{{route('terms')}}" class="link-secondary">شروط  &amp; واحكام</a></li>
                                <li class="list-inline-item"><a href="{{route('privacy')}}" class="link-secondary">سياسة الخصوصية</a></li>
                            </ul>
                        </div>
