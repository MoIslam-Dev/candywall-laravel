...
class Admins extends Controller
{
    ...
    public function update(Request $req)
    {
        $this->validate($req, [
            ...
            'password_1' => 'nullable|string|regex:/(^[a-zA-Z0-9._#,@*&!%-]+$)+/|between:8,40',
    ...
    {
        $note = $req->post('a_note');
        if ($note == null) {
            DB::table('misc')->where('name', 'admin_note')->delete();
        } else {
            DB::table('misc')->updateOrInsert(['name' => 'admin_note'], ['data' => $note]);
        }
